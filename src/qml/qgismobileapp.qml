...
ApplicationWindow {
    ...
    Row {
      ...
      Item {
        ...
        Timer {
          ...
          repeat: true
          onTriggered: {
            compassNeedle.rotation = positionSource.positionInformation.orientationValid ? 
              positionSource.positionInformation.orientation : 0
          }
        }
  ...
  Menu {
    ...
    MenuItem {
      ...
      font: Theme.defaultFont
      icon.source: Theme.getThemeVectorIcon("ic_close_black_24dp")
      height: 48
      leftPadding: Theme.menuItemLeftPadding
      enabled: qgisProject && qgisProject.fileName !== ''

      onTriggered: {
        mainMenu.close();
        dashBoard.close();
        dashBoard.closeProject();
      }
    }
